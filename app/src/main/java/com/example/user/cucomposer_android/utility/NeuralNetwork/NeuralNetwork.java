...
public class NeuralNetwork {
    ...
    public HashMap<String, Double> weightUpdate = new HashMap<String, Double>();
    ...
    public void setOutputs(double[][] y){
        expectedOutputs=y;
    }
    ...
    public double run(int maxSteps, double minError) {
        int i;
        // Train neural network until minError reached or maxSteps exceeded
        resultOutputs = new double[inputs.length][expectedOutputs[0].length];
        double error = 1;
...
//        }
    ...
    public void saveWeight(String weightFile) throws IOException{
        PrintWriter w=new PrintWriter(weightFile,"UTF-8");
        w.print(this.getWeight());
        w.close();
    }
